...
public class MainFrame extends JFrame{
	...
	public MainFrame(String sourcePath,String targetPath) {
		...
		HashMap<Integer,double[][]> result1=ImageTransform.getGaussPyramid(Image_Utility.imageToDoubleArray(sourceImage), 20, 3,1.6);
		HashMap<Integer,double[][]> result2=ImageTransform.getGaussPyramid(Image_Utility.imageToDoubleArray(targetImage), 20, 3,1.6);
		   
	      
		HashMap<Integer,double[][]> dog1=ImageTransform.gaussToDog(result1, 6);
		HashMap<Integer,double[][]> dog2=ImageTransform.gaussToDog(result2, 6);
		HashMap<Integer,List<MyPoint>> keyPoints1=ImageTransform.getRoughKeyPoint(dog1,6);
		HashMap<Integer,List<MyPoint>> keyPoints2=ImageTransform.getRoughKeyPoint(dog2,6);
		keyPoints1=ImageTransform.filterPoints(dog1, keyPoints1, 10,0.03);
		keyPoints2=ImageTransform.filterPoints(dog2, keyPoints2, 10,0.03);
		sourceImage=ImageTransform.drawPoints(result1,keyPoints1);
		targetImage=ImageTransform.drawPoints(result2,keyPoints2);
	...
	*/	
		...
		*/
		...
		l3.setIcon(new ImageIcon(Image_Utility.doubleArrayToGreyImage(result1.get(1))));
		l4.setIcon(new ImageIcon(Image_Utility.doubleArrayToGreyImage(result1.get(2))));
		l5.setIcon(new ImageIcon(Image_Utility.doubleArrayToGreyImage(result1.get(3))));
		l6.setIcon(new ImageIcon(Image_Utility.doubleArrayToGreyImage(result1.get(8))));
